...
### 프로모션 텍스트 (170자)
```
🆕 조용한 공간의 필수품! 완전한 무음 촬영으로 도서관, 강의실에서 자유롭게 메모하세요. Quiet Mode로 더욱 조용하게! 📸
```
